...
// ASCII Donut Animation (for reference.html)
// Original JS by @housamz, adapted for integration
function runDonutAnimation() {
  const pre = document.getElementById("donut-animation");
...
// Run the donut animation after the document is ready
$(document).ready(function() {
  runDonutAnimation();
});
